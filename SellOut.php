...
<section>
    ...
    <div>
        ...
        <div>
            ...
            <div>
                <?php
                    echo '<form action="SellDown.php?id='.$id.'&chanpin='.$chanpin.'&buybzj='.$buybzj.'&baozhuang='.$baozhuang.'&UnitPrice='.$UnitPrice.'&Total='.($buybzj+$baozhuang).'&buybzj='.$buybzj.'&set='.$set.'&user='.$user.'" method="post">';
                ?>
...
<footer></footer>
<script type="text/javascript" src="js/SellOut.js"></script>
</body>
</html>